...
async function setupTablesPg() {
  ...
  const columns = [
    `ALTER TABLE societies DROP COLUMN IF EXISTS code`,
    `ALTER TABLE societies DROP COLUMN IF EXISTS banner_image`,
    ...
    `ALTER TABLE vendors DROP COLUMN IF EXISTS renewal_date`,
    ...
    `ALTER TABLE users DROP COLUMN IF EXISTS joined_date`,
    ...
    `ALTER TABLE sub_admins DROP COLUMN IF EXISTS assigned_society_id`,
    `ALTER TABLE support_tickets DROP COLUMN IF EXISTS master_ticket_number`,
    ...
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS priority VARCHAR(32) DEFAULT 'medium'`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS status VARCHAR(32) DEFAULT 'open'`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS user_type VARCHAR(32) DEFAULT 'user'`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS source VARCHAR(64) DEFAULT 'landing_website'`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS reporter_name VARCHAR(128)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS reporter_email VARCHAR(128)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS reporter_user_id VARCHAR(64)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS entity_name VARCHAR(128)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS target_vendor VARCHAR(128)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS order_id VARCHAR(64)`,
    ...
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS created_at_ist TIMESTAMP WITH TIME ZONE DEFAULT NOW()`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS created_at_readable VARCHAR(64)`,
    `ALTER TABLE support_tickets ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS sender_name VARCHAR(128)`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS sender_role VARCHAR(32)`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS sender_avatar VARCHAR(255)`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS is_internal_note BOOLEAN DEFAULT FALSE`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS created_at_ist TIMESTAMP WITH TIME ZONE DEFAULT NOW()`,
    `ALTER TABLE ticket_messages ADD COLUMN IF NOT EXISTS created_at_readable VARCHAR(64)`,
    `ALTER TABLE ticket_attachments ADD COLUMN IF NOT EXISTS file_name VARCHAR(255)`,
    `ALTER TABLE ticket_attachments ADD COLUMN IF NOT EXISTS file_size_bytes INT`,
    `ALTER TABLE ticket_attachments ADD COLUMN IF NOT EXISTS file_url VARCHAR(512)`,
    `ALTER TABLE ticket_attachments ADD COLUMN IF NOT EXISTS uploaded_by VARCHAR(128)`,
    `ALTER TABLE ticket_attachments ADD COLUMN IF NOT EXISTS uploaded_at_ist TIMESTAMP WITH TIME ZONE DEFAULT NOW()`,
    ...
    `ALTER TABLE vendors DROP COLUMN IF EXISTS ifsc`,
    `ALTER TABLE vendors DROP COLUMN IF EXISTS upi_qr_code`,
    `ALTER TABLE vendors DROP COLUMN IF EXISTS qr_code_url`,
    `ALTER TABLE vendors DROP COLUMN IF EXISTS opening_timing`,
    `ALTER TABLE vendors DROP COLUMN IF EXISTS closing_timing`,
    `ALTER TABLE vendors DROP COLUMN IF EXISTS payment_instructions`,
    ...
    `ALTER TABLE vendors ADD COLUMN IF NOT EXISTS pincode VARCHAR(20)`,
    `ALTER TABLE vendors ADD COLUMN IF NOT EXISTS working_days VARCHAR(100) DEFAULT 'Mon – Sun'`,
    `ALTER TABLE vendors ADD COLUMN IF NOT EXISTS business_type VARCHAR(50) DEFAULT 'PRODUCT'`,
    `ALTER TABLE vendors ADD COLUMN IF NOT EXISTS opening_time VARCHAR(20) DEFAULT '08:00 AM'`,
    `ALTER TABLE vendors ADD COLUMN IF NOT EXISTS closing_time VARCHAR(20) DEFAULT '10:00 PM'`,
    `ALTER TABLE items ADD COLUMN IF NOT EXISTS stock INT DEFAULT 50`,
    `ALTER TABLE items ADD COLUMN IF NOT EXISTS unit VARCHAR(50) DEFAULT '1 piece'`,
