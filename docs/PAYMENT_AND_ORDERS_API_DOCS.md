...
For complete detailed documentation on order status state machines, input mapping, error cases, and UI badge palettes, see [ORDER_STATUS_API_DOCS.md](file:///c:/Users/LENOVO/Desktop/digilocal_backend_mock/docs/ORDER_STATUS_API_DOCS.md).
